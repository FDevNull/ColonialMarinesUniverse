...
humanoid-profile-editor-tts-voice-label = Voice:
humanoid-profile-editor-tts-voice-tooltip = Select a synthesized voice. Type in the opened list to search by name or source.
humanoid-profile-editor-tts-voice-source = Source: {$source}
humanoid-profile-editor-tts-voice-unavailable = No compatible voices are available.
